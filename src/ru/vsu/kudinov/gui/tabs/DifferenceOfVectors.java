...
public class DifferenceOfVectors extends Tab
{

    private JLabel labelResult = new JLabel("The difference of the vectors:");

    public DifferenceOfVectors()
    {
        setLayout(null);
        setFont(font);
        setBackground(color);
    ...
    ActionListener performActionCalcButtonListener()
    {
        return e ->
        {
            ...
            Vector resultVector = firstVector.calculateDifferenceOfVectors(secondVector);
