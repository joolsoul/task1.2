...
public class VectorProductOfVectors extends Tab
{

    private JLabel labelResult = new JLabel("The vector product of the vectors:");
    ...
    ActionListener performActionCalcButtonListener()
    {
        return e ->
        {
            ...
            Vector resultVector = firstVector.calculateVectorProductOfVectors(secondVector);
