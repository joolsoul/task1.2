...
public class ProjectionOfVector extends Tab
{

    private JLabel labelResult = new JLabel("The projection of the first vector on the second vector:");

    public ProjectionOfVector()
    {
        setLayout(null);
        setFont(font);
        setBackground(color);
        ...
        labelResult.setBounds(105, 200, 310, 20);
        add(labelResult);

        fieldResult.setBounds(435, 200, 130, 20);
    ...
    ActionListener performActionCalcButtonListener()
    {
        return e ->
        {
            ...
            double projection = firstVector.calculateProjectionOfVector(secondVector);
            fieldResult.setText(Double.toString(projection));
        };
    }
}
